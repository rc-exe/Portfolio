...
<section id="about" className="py-20 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
  ...
  >
    {/* Section Title */}
    <h2 className="text-3xl sm:text-4xl font-bold mb-10 sm:mb-12 text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
      About Me
    </h2>
      ...
      <div className="relative">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl p-4 sm:p-6 shadow-2xl border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-6">
            {/* Placeholder for future tech tags */}
          </div>
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-4 sm:p-5 font-mono text-sm text-gray-800 dark:text-gray-100 shadow-inner overflow-x-auto">
            ...
            <pre className="whitespace-pre-wrap">
              <code>
                ...
                <span className="text-pink-400">'Ritesh Chakramani'</span>,{"\n"}
                &nbsp;&nbsp;<span className="text-green-400">role</span>:{" "}
                <span className="text-pink-400">'Full-Stack Developer'</span>,{"\n"}
                &nbsp;&nbsp;<span className="text-green-400">passion</span>:{" "}
                <span className="text-pink-400">'Building innovative solutions'</span>
                {"\n"}
                &#125;;
              </code>
            </pre>
